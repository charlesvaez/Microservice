package com.hgsoft.springcloud.apollo.sample;
...
//
        ...
        writeJarFile("D:\\books\\配置中心\\Apollo\\apollo-adminservice-1.3.0-github\\apollo-adminservice-1.3.0.jar","application.yml",data.getBytes());
