...
/* package */abstract class AbstractCommand<R> implements HystrixInvokableInfo<R>, HystrixObservable<R> {
    ...
    protected AbstractCommand(HystrixCommandGroupKey group, HystrixCommandKey key, HystrixThreadPoolKey threadPoolKey, HystrixCircuitBreaker circuitBreaker, HystrixThreadPool threadPool,
        ...
        System.out.println("initGroupKey: "+(endTime1-startTime));

        this.commandKey = initCommandKey(key, getClass());
        long endTime2 = System.currentTimeMillis();
        System.out.println("initCommandKey: "+(endTime2-endTime1));

        this.properties = initCommandProperties(this.commandKey, propertiesStrategy, commandPropertiesDefaults);
        long endTime3 = System.currentTimeMillis();
        System.out.println("initCommandProperties: "+(endTime3-endTime2));

        this.threadPoolKey = initThreadPoolKey(threadPoolKey, this.commandGroup, this.properties.executionIsolationThreadPoolKeyOverride().get());
        long endTime4 = System.currentTimeMillis();
        System.out.println("initThreadPoolKey: "+(endTime4-endTime3));

        this.metrics = initMetrics(metrics, this.commandGroup, this.threadPoolKey, this.commandKey, this.properties);
        long endTime5 = System.currentTimeMillis();
        System.out.println("initMetrics: "+(endTime5-endTime4));

        this.circuitBreaker = initCircuitBreaker(this.properties.circuitBreakerEnabled().get(), circuitBreaker, this.commandGroup, this.commandKey, this.properties, this.metrics);
        long endTime6 = System.currentTimeMillis();
        System.out.println("initCircuitBreaker: "+(endTime6-endTime5));

        this.threadPool = initThreadPool(threadPool, this.threadPoolKey, threadPoolPropertiesDefaults);
        long endTime7 = System.currentTimeMillis();
        System.out.println("initThreadPool: "+(endTime7-endTime6));
        ...
        System.out.println("all: "+(endTime8-startTime));
    }
